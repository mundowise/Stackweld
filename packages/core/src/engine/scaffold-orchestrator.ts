...
export class ScaffoldOrchestrator {
  ...
  generate(stack: StackDefinition): ScaffoldOutput {
    ...
    return {
      dockerCompose: dockerServices.length > 0
        ? this.generateDockerCompose(stack, techs)
        : null,
  ...
  generateDockerCompose(
    ...
    for (const tech of techs) {
      ...
      const stackTech = stack.technologies.find(
        (st) => st.technologyId === tech.id,
      );
  ...
  generateReadme(
    ...
    const lines: string[] = [
      `# ${stack.name}`,
      "",
      stack.description || "A project generated by StackPilot.",
      "",
      "## Stack",
      "",
    ...
    lines.push("---");
    lines.push("");
    lines.push(`*Generated by [StackPilot](https://github.com/stackpilot) — Profile: ${stack.profile}*`);
  ...
  generateDevcontainer(
    ...
    const devcontainer: Record<string, unknown> = {
      ...
      postCreateCommand: "echo 'StackPilot devcontainer ready'",
    };
  ...
  generateVscodeSettings(techs: Technology[]): string {
    ...
    return JSON.stringify(
      {
        ...output,
        "stackpilot.recommendedExtensions": recommendations,
      },
      null,
      2,
    ) + "\n";
