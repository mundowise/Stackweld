...
export const technologies = [
  {
    ...
    category: "auth",
    description:
      "Drop-in authentication and user management with prebuilt UI components and multi-tenant support",
  ...
  },
  {
    ...
    category: "auth",
    description:
      "Authentication library for Next.js with OAuth, credentials, and database session support",
    ...
    configFiles: ["auth.ts", "[...nextauth].ts"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    category: "auth",
    description:
      "Open-source authentication with row-level security, social logins, and magic links powered by GoTrue",
    ...
    configFiles: ["supabase/config.toml", "lib/supabase.ts"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    configFiles: [".env", "composer.json", "artisan"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    incompatibleWith: ["express", "fastify"],
    suggestedWith: ["prisma", "postgresql"],
  ...
  },
  {
    ...
    dockerImage: null,
    envVars: {},
    configFiles: [".devcontainer/devcontainer.json"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    category: "devops",
    description:
      "CI/CD platform integrated with GitHub for automating build, test, and deploy workflows",
  ...
  },
  {
    ...
    dockerImage: null,
    envVars: {},
    configFiles: ["pnpm-workspace.yaml", ".npmrc"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    envVars: {},
    configFiles: [".storybook/main.ts", ".storybook/preview.ts"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    defaultPort: 4200,
    requires: ["nodejs"],
    incompatibleWith: ["nextjs", "nuxt", "sveltekit", "qwik", "solidjs"],
    suggestedWith: ["typescript"],
  ...
  },
  {
    ...
    incompatibleWith: ["nuxt", "sveltekit", "angular", "remix"],
  ...
  },
  {
    ...
    defaultPort: 3000,
    requires: ["nodejs", "vue"],
    incompatibleWith: ["nextjs", "sveltekit", "angular", "remix"],
  ...
  },
  {
    ...
    defaultPort: 5173,
    requires: ["nodejs"],
    incompatibleWith: ["react", "vue", "svelte", "angular"],
    suggestedWith: ["typescript", "tailwindcss"],
  ...
  },
  {
    ...
    defaultPort: 3000,
    requires: ["nodejs", "react"],
    incompatibleWith: ["nextjs", "nuxt", "sveltekit", "astro"],
    suggestedWith: ["typescript", "tailwindcss", "prisma"],
    ...
    configFiles: ["remix.config.js", "package.json"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    incompatibleWith: ["nextjs", "nuxt", "angular", "remix"],
    suggestedWith: ["typescript", "tailwindcss", "prisma"],
  ...
  },
  {
    ...
    category: "orm",
    description:
      "Next-generation Node.js and TypeScript ORM with auto-generated query builder and migrations",
  ...
  },
  {
    ...
    healthCheck: {
      command:
        "npx ts-node -e \"import { DataSource } from 'typeorm'; new DataSource({type:'postgres',url:process.env.DATABASE_URL}).initialize()\"",
    },
    envVars: {
      DATABASE_URL: "postgresql://postgres:postgres@localhost:5432/app",
    },
  ...
  },
  {
    ...
    configFiles: ["deno.json", "deno.lock"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    configFiles: ["php.ini", "composer.json"],
    lastVerified: "2026-03-22",
  ...
  },
  {
    ...
    envVars: {},
    configFiles: ["traefik.yml", "traefik.toml"],
    lastVerified: "2026-03-22",
