 ...
 * Premium visual design for StackPilot CLI.
 */

import type { StackDefinition, Technology, Template, ValidationResult } from "@stackpilot/core";
...
export function banner(version: string): string {
  const lines = [
    "",
    BRAND_COLOR.bold("  StackPilot") + chalk.dim(` v${version}`),
