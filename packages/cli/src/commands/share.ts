/**
 * stackpilot share <stackId> — Generate a shareable URL for a saved stack.
 * stackpilot import-url <url> — Import a stack from a share URL.
 *
...
export const shareCommand = new Command("share")
  ...
  .option("--base-url <url>", "Custom base URL", "https://stackpilot.dev/s/#")
  .action((id: string, opts) => {
    ...
    const content = [
      ...
      `  import it with:`,
      `  ${chalk.white("stackpilot import-url <url>")}`,
      "",
...
export const importUrlCommand = new Command("import-url")
  ...
  .argument("<url>", "Share URL generated by stackpilot share")
