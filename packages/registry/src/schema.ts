...
export const technologySchema = {
  ...
  required: [
    ...
    "versions", "defaultVersion", "requires", "incompatibleWith",
    "suggestedWith", "envVars", "configFiles", "lastVerified", "tags",
  ],
  properties: {
    ...
    category: {
      type: "string",
      enum: ["runtime", "frontend", "backend", "database", "orm", "auth", "styling", "service", "devops"],
    },
